...
import "../styles/Pages/Details-Gallery/details-gallery.css";

export const DetailsGallery = () => {
  return (
    <div className="detailsGallery">
      <div className="detailsGallery__img">
      ...
      <div className="detailsGallery__login-form">
        <h1 className="detailsGallery__title">Album chroniony</h1>
        <p className="detailsGallery__text">
          Aby wejść do galerii musisz podać hasło, które otrzymałeś w mailu.
        </p>
        ...
        <button type="button" className="detailsGallery__button">
          Odblokuj
        </button>
      </div>
    </div>
